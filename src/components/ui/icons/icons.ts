export const Icons = {
  ...
  arrowLeft: {
    ...
    class:
      "h-4 w-4 flex-shrink-0 transition duration-300 group-hover:-translate-x-1", // Changed to negative translate on hover for the left arrow.
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  github: {
    ...
    class:
      "w-4.5 h-4.5 transition flex-shrink-0 text-neutral-800 duration-300 group-hover:-translate-y-1 hover:text-neutral-700",
    width: 16,
    height: 16,
    viewBox: "0 0 16 16",
    fill: "currentColor",
  ...
  slack: {
    ...
    class:
      "h-5 w-5 mt-1 flex-shrink-0 fill-current text-neutral-700 dark:text-neutral-400",
    viewBox: "0 0 24 24",
    fill: "currentColor",
    title: "Slack",
  },
